...
def delivery_report(err, msg):
    ...
    if err is not None:
        ...
        return
    print(
        "Visit record with Id {} successfully produced to Topic:{} Partition: [{}] at offset {}".format(
...
def main():
    ...
    avro_serializer = AvroSerializer(schema_registry_client, schema_str, visit_to_dict)
        ...
        for column in reader:
            ...
            producer.produce(
                ...
                value=avro_serializer(
                    visit, SerializationContext(topic, MessageField.VALUE)
                ),
